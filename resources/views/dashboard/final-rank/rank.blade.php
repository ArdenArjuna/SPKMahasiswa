...
@section('content')
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Perhitungan Akhir</h1>
  </div>

  <div class="table-responsive col-lg-12">
    <div class="d-lg-flex justify-content-between gap-2">
      <h1 class="h3 mb-0 text-gray-800">Normalisasi Tabel</h1>
      <a href="{{ url('dashboard/final-ranking') }}" class="btn btn-secondary mb-3">
        <span data-feather="arrow-left"></span>
        Kembali ke Perhituangan Akhir
      </a>
    </div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between align-items-center my-4">
      <h1 class="h3 mb-0 text-gray-800">Perhituangan Nilai Mahasiswa</h1>
    </div>
