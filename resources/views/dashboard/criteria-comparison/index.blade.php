          ...
          @foreach ($comparisons as $comparison)
            <tr>
              ...
              <td class="text-center">
                <a href="{{ url('dashboard/criteria-comparisons/'. $comparison->id) }}" class="badge bg-success text-decoration-none">
                  See Comparison Values
                </a>
                <form action="{{ url('dashboard/criteria-comparisons/'. $comparison->id) }}" method="POST" class="d-inline">
                  @method('delete')
                  @csrf
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalChooseLabel">Perbandingan Kriteria</h5>
