...
@section('content')
  ...
  <div class="table-responsive col-lg-12">
    <div class="d-lg-flex justify-content-between gap-2">
      ...
      <a href="{{ url('dashboard/criteria-comparisons/'. $criteria_analysis->id) }}" class="btn btn-secondary mb-3">
            ...
            <tr>
              @if ($CR > 0.1)
                <td class="text-center text-danger" colspan="2">
                  ...
                  <a href="{{ url('dashboard/criteria-comparisons/'. $criteria_analysis->id) }}" class="btn btn-danger mt-2">Reinput Comparison Values</a>
                </td>
              @elseif(!$isAbleToRank)
              <td class="text-center text-danger" colspan="2">
              ...
              @else
                ...
                <td>
                  <a href="{{ url('dashboard/final-ranking/'. $criteria_analysis->id) }}" class="btn btn-success">
                    Rank Mahasiswa
                  </a>
                </td>
              @endif
