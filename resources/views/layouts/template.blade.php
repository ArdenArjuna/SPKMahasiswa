...
<head>
  ...
  <title>@yield('judul') - Tempat PKL</title>
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{url('/Tentang')}}#Tentang">Tentang</a></li>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            <a href="{{url('/')}}" class="logo d-flex align-items-center">
              <img src="{{asset('tema/img/.png')}}" alt="">
              <span>Rekomendasi Tempat PKL</span>
            </a>
            <p>Mempermudah Mahasiswa untuk memilih tempat PKL terbaik</p>
            <div class="social-links mt-3">
              <a href="#" class="twitter"><i class="bi bi-twitter"></i></a>
              <a href="#" class="facebook"><i class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/arden_arjuna/"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              Slawi, No. 28<br>
              Jawa Tengah <br><br>
              <strong>Phone:</strong>+6287824034008<br>
              <strong>Email:</strong>ardenarjuna28@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Rekomendasi Tempat PKL</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
